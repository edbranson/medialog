...
function displayUserTable() {
    ...
    for (let i = 0; i < data.length; i++) {
        var row = `<tr id= "user-${data[i].id}">
                <td style="display:none;" id="userId">${data[i].id}</td>
                <td id="userCheckBox"><input type="checkbox"></td>
                <td id="userFirstName">${data[i].firstName}</td>
                </tr>`
        console.log(row)        
        table.innerHTML += row
    }
...
function displayMediaTypes() {
    ...
    for (let i = 0; i < data.length; i++) {
        var row = `<tr id= "type-${data[i]}">
                <td id="userCheckBox"><input type="checkbox"></td>
                <td id="userFirstName">${data[i]}</td>
                </tr>`
        console.log(row)        
        table.innerHTML += row
    }
...
function displayRatings() {
    ...
    for (let i = 0; i < data.length; i++) {
        var row = `<tr id= "rating-${data[i]}">
                <td id="ratingCheckBox"><input type="checkbox"></td>
                <td id="ratingItem">${data[i]}</td>
                </tr>`
        console.log(row)        
        table.innerHTML += row
    }
...
function filterEntryTbodyByUser(event) {
    var filter = event.target.value.toUpperCase();
    var rows = document.querySelector("#entryTbody").rows;
...
document.querySelector('#mediaSearchInput').addEventListener('keyup', filterEntryTbodyByUser, false);
